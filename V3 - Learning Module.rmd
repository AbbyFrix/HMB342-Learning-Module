...
```{r exercise3, exercise= TRUE, exercise.lines = 5}
...
##  **read.csv** 
```{r exercise4, exercise= TRUE, exercise.lines = 6}
...
```{r exercise4a, exercise= TRUE, exercise.lines = 6}
...
For this section of the module, we will be covering some common functions in R to tidy datasets.
...
```{r exercise5, exercise= TRUE, exercise.lines = 5, exercise.setup="exercise5setup"}
#mean_pfos_by_sample<- 
...
```{r, exercise5solution,messag=FALSE, echo=FALSE, results=FALSE}
# SOLUTION
mean_pfoa_by_sample <- pfas_data %>%
  filter(Analyte == "PFOA") %>% #filtering to only get PFOA
  group_by(Utility) %>% 
...
## Plotting One Variable - Numerical Data
...
```{r exercise8, exercise= TRUE, exercise.lines = 8, exercise.setup="exercise8setup"}
...
```{r exercise9, exercise= TRUE, exercise.lines = 5, exercise.setup="exercise9setup"}
...
```{r exercise10, exercise= TRUE, exercise.lines = 5, exercise.setup="exercise10setup"}
pfas_data_mean %>% 
...
## Plotting one Variable - Categorical Data 
...
```{r exercise12, exercise= TRUE, exercise.lines = 8, exercise.setup="exercise12setup"}
cannabis_data %>% 
...
```{r exercise13, exercise= TRUE, exercise.lines = 5, exercise.setup="exercise13setup"}
...
```{r exercise14, exercise= TRUE, exercise.lines = 5, exercise.setup="exercise14setup"}
pfas_data %>%
  filter(State == "NJ") %>%
  group_by(Analyte) %>%
...
```{r exercise15, exercise= TRUE, exercise.lines = 5, exercise.setup="exercise15setup"}
...
```{r exercise16, exercise= TRUE, exercise.lines = 6, exercise.setup="exercise16setup"}
...
```{r exercise17, exercise= TRUE, exercise.lines = 6, exercise.setup="exercise17setup"}
...
## Base R Functions - Numerical Data
...
## Visualizing Data Using Base R Functions - Categorical Data, One Variable
...
## Visualizing Data Using Base R Functions - Categorical Data, Two Variables
...
```{r exercise18, exercise= TRUE, exercise.lines = 10, exercise.setup="exercise18setup"}
...
### *Putting it all Together: Layout, Structure and Purpose*
